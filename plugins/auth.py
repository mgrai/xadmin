...
class GroupAdmin(AbstractObjectAdmin):
    search_fields = ('name',)
    ordering = ('name',)
...
#         return super(GroupAdmin, self).save_models()
#     
#     def queryset(self):
#         if self.user.is_superuser:
#             return super(GroupAdmin, self).queryset()
#         else:   
#             return super(GroupAdmin, self).queryset().filter(company=self.user.company)
...
class UserAdmin(AbstractObjectAdmin):
...
#     def save_models(self):
#         self.new_obj.company = self.user.company
#         return super(UserAdmin, self).save_models()
#     
#     def queryset(self):
#         if self.user.is_superuser:
#             return super(UserAdmin, self).queryset()
#         else:   
#             return super(UserAdmin, self).queryset().filter(company=self.user.company)
...
site.register(CompanyGroup, GroupAdmin)
