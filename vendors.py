...
vendors = {
    ...
    "select": {
        ...
        "js": {
            'dev': ['xadmin/vendor/selectize/selectize.js', 'xadmin/vendor/select2/select2.js', 'xadmin/vendor/select2/select_cascade.js'],
    ...
    "my": {
        "js": {
            'dev': 'myplugins/js/my.plugin.details.js',
        }
    },       
